 ...
 */
    ...
    hasMinorDiagonalConflictAt: function(minorDiagonalColumnIndexAtFirstRow) {
      ...
      var rowIndex;
      var count = 0;
      if(minorDiagonalColumnIndexAtFirstRow > length - 1) {
        var difference = colIndex - length;
        noOfRows = length - 1 - difference;
        colIndex = length - 1;
        rowIndex = difference + 1;
      }
      else {
        rowIndex = 0;
        noOfRows = colIndex + 1;
